...
public abstract class JdbcMealRepository implements MealRepository {
    ...
    public List<Meal> getBetweenInclusive(LocalDate startDate, LocalDate endDate, int userId) {
        return jdbcTemplate.query(
                ...
                ROW_MAPPER, userId, convertLocalDateTime(getStartInclusive(startDate)), convertLocalDateTime(getEndExclusive(endDate)));
    }

    protected abstract Object convertLocalDateTime(LocalDateTime dateTime);
