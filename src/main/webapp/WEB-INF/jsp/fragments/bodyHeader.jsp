            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item ${pageContext.response.locale == 'en' ? 'active' : ''}"
                           href="${pageContext.request.contextPath}/login?lang=en">English</a>
                        <a class="dropdown-item ${pageContext.response.locale == 'ru' ? 'active' : ''}"
                           href="${pageContext.request.contextPath}/login?lang=ru">Русский</a>
                    </div>
                </li>
            </ul>
        </div>
