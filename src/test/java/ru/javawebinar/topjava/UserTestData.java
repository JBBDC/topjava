...
public class UserTestData {
    ...
    public static User getNewNotValid() {
        return new User(null, "New with no email", "", "newPass", 1555, false, new Date(), Collections.singleton(Role.ROLE_USER));
    }
    ...
    public static User getUpdatedNotValid() {
        User updated = new User(USER);
        updated.setName("Invalid calories");
        updated.setCaloriesPerDay(33000);
        updated.setRoles(Collections.singletonList(Role.ROLE_ADMIN));
        return updated;
    }
